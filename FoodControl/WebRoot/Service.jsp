...
<body>
	...
	<div class="container-fluid" id="div">
		...
		<div class="row1 row">
			...
			<a class="btn btn-info btn-lg col-sm-offset-1" href="#" role="button">交班</a>
			<a class="btn btn-info btn-lg col-sm-offset-1" href="#" role="button">刷新</a>
					...
					<div id="all">
						...
						<div id="all-home1">
							...
							<div class="pull-right">
								<h4 class="text-success">已结单:8</h4>
							</div>
							<div class="pull-right">
								<h4 class="text-danger">未结单:12</h4>
							</div>
							<div class="pull-right">
								<h4 class="text-primary">总单数:20</h4>
							</div>
						</div>
					</div>
				</div>
